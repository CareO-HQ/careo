...
import { runMedicationLowStockCron } from "@/lib/medication-low-stock-cron";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await runMedicationLowStockCron(supabase);
    ...
    console.error("Cron medication-low-stock-alerts failed:", error);
