...
function ClinicalAuditViewSinglePageContent() {
  ...
  useEffect(() => {
    ...
    const fetchResponse = async () => {
      try {
        const response = await auditService.getClinicalResponseById(responseId);
  ...
  useEffect(() => {
    ...
    const fetchActionPlans = async () => {
      try {
        const plans = await auditService.getClinicalActionPlans(responseId);
  ...
  const handleDeleteActionPlan = async () => {
    ...
    try {
      await auditService.deleteClinicalActionPlan(actionPlanToDelete);
