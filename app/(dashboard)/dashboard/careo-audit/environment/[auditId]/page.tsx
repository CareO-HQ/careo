...
export default function EnvironmentAuditPage() {
  ...
  const deleteActionPlanMutation = useMutation(api.environmentAuditActionPlans.deleteActionPlan);
    ...
    try {
      ...
      if (isDbPlan) {
        await deleteActionPlanMutation({
          actionPlanId: actionPlanToDelete as Id<"environmentAuditActionPlans">
        });
      }
  ...
  // For environment audits, we don't need to filter by auditId because dbActionPlans
