...
function EnvironmentAuditViewSinglePageContent() {
  ...
  useEffect(() => {
    ...
    const fetchResponse = async () => {
      try {
        const response = await auditService.getEnvironmentResponseById(responseId);
  ...
  useEffect(() => {
    ...
    const fetchActionPlans = async () => {
      try {
        const plans = await auditService.getEnvironmentActionPlans(responseId);
  ...
  const handleDeleteActionPlan = async () => {
    ...
    try {
      await auditService.deleteEnvironmentActionPlan(actionPlanToDelete);
