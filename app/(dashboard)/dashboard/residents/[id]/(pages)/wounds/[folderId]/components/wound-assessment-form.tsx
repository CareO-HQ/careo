...
const WoundAssessmentSchema = z.object({
  ...
  regularOngoingAnalgesia: z.boolean().default(false),
  preDressingOnly: z.boolean().default(false),
  ...
  necroticPercentage: z.number().min(0).max(100).default(0),
  sloughyPercentage: z.number().min(0).max(100).default(0),
  granulatingPercentage: z.number().min(0).max(100).default(0),
  epithelialisingPercentage: z.number().min(0).max(100).default(0),
  hypergranulatingPercentage: z.number().min(0).max(100).default(0),
  haematomaPercentage: z.number().min(0).max(100).default(0),
  boneTendonPercentage: z.number().min(0).max(100).default(0),
  ...
  periwoundSkin: z.array(z.string()).default([]),

  // Section 7: Signs of Infection
  signsOfInfection: z.array(z.string()).default([]),
