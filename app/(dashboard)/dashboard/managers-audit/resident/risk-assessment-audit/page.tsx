...
export default function RiskAssessmentAuditPage() {
  ...
  const handleSubmit = () => {
    ...
    // Navigate to resident-report page to show latest audits
    router.push('/dashboard/managers-audit/resident-report');
  };
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold">Risk Assessment Audit</h1>
          </div>
        </div>
        <Button
          variant="outline"
          className="gap-2"
          onClick={() => router.push('/dashboard/managers-audit/resident/risk-assessment-audit/archived')}
        >
