...
function testLogic(scenario, userNowDate, selectedStartDate) {
    console.log(`\n--- ${scenario} ---`);
...
// Real time: Feb 11, 21:00 IST -> Feb 11, 15:30 GMT
// User selects Today in calendar -> Feb 11 00:00 Local
...
// Real time: Feb 11, 10:00 EST -> Feb 11, 15:00 GMT
