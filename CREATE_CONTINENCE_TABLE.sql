...
-- Create continence_entries table
CREATE TABLE IF NOT EXISTS public.continence_entries (
  ...
  -- Urine-specific fields (for future implementation)
  urine_color TEXT,
  urine_amount TEXT,
  urine_odor TEXT,
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_continence_entries_resident_id ON public.continence_entries(resident_id);
CREATE INDEX IF NOT EXISTS idx_continence_entries_organization_id ON public.continence_entries(organization_id);
CREATE INDEX IF NOT EXISTS idx_continence_entries_date ON public.continence_entries(date);
CREATE INDEX IF NOT EXISTS idx_continence_entries_entry_type ON public.continence_entries(entry_type);
CREATE INDEX IF NOT EXISTS idx_continence_entries_recorded_by ON public.continence_entries(recorded_by);
...
SELECT COUNT(*) as row_count FROM public.continence_entries;
