          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 rounded-md border bg-muted/10">
                <div className={`w-4 h-4 mt-0.5 flex-shrink-0 rounded-sm border-2 flex items-center justify-center ${data.understandsPRN ? "bg-green-500 border-green-500" : "border-muted-foreground"}`}>
                  {data.understandsPRN && (
              ...
              <div className="flex items-start gap-3 p-3 rounded-md border bg-muted/10">
                <div className={`w-4 h-4 mt-0.5 flex-shrink-0 rounded-sm border-2 flex items-center justify-center ${data.agreesToPRN ? "bg-green-500 border-green-500" : "border-muted-foreground"}`}>
                  {data.agreesToPRN && (
                    <svg className="w-2.5 h-2.5 text-white" fill="none" viewBox="0 0 12 12">
                      <path d="M2 6l3 3 5-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
