...
export const createColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const medicationIntake = row.original;
      const medication = medicationIntake.medication;
      ...
      const AdministrateDialog = () => {
        ...
        const handleAdministrate = async () => {
          ...
          try {
            ...
            if (notes.trim() && saveMedicationIntakeComment) {
              await saveMedicationIntakeComment({
                intakeId: medicationIntake._id,
                comment: notes
              });
            ...
            toast.error(
              "Failed to administer medication: " + (error as Error).message
            );
          }
        };
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="rounded-md border p-3 space-y-1">
                    <p className="font-semibold">{medication?.name || "N/A"}</p>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Scheduled:{" "}
                      {formatInTimeZone(
                        new Date(medicationIntake.scheduledTime),
                        "UTC",
                        "HH:mm"
                      )}
                    </p>
