  ...
  "bed-rails-risk-assessment-form": [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "Gap between rail and mattress", path: "decision.safetyChecklist.gapBetweenRailAndMattress" },
        { label: "Mattress compresses easily", path: "decision.safetyChecklist.mattressCompressesEasily" },
        { label: "Gap >60mm", path: "decision.safetyChecklist.gapMoreThan60mm" },
        { label: "Bed rail insecure", path: "decision.safetyChecklist.bedRailInsecure" },
        { label: "Bed against wall", path: "decision.safetyChecklist.bedAgainstWall" },
    ...
    },
    {
      ...
      fields: [
        { label: "Is the extended bed rail positioned correctly?", path: "decision.extendedHeightChecks.positionedCorrectly" },
        { label: "Is the extended height rail securely fastened?", path: "decision.extendedHeightChecks.securelyFastened" },
        { label: "Are correct bumpers installed?", path: "decision.extendedHeightChecks.correctBumpersInstalled" },
        { label: "Mattress below plimsoll line?", path: "decision.extendedHeightChecks.mattressBelowPlimsollLine" },
        { label: "Staff trained?", path: "decision.extendedHeightChecks.staffTrained" },
        { label: "Checked for damage/wear?", path: "decision.extendedHeightChecks.checkedForDamage" },
