...
export default function BestInterestDecisionDialog({
  ...
  const form = useForm<BestInterestDecisionFormData>({
    ...
    defaultValues: initialData ? {
      ...
      residentIdNumber: initialData.assessment_data?.residentIdNumber ?? initialData.residentIdNumber,
      dateOfDecision: initialData.assessment_data?.dateOfDecision ?? initialData.dateOfDecision,
      typeOfDecision: initialData.assessment_data?.typeOfDecision ?? initialData.typeOfDecision,
      ...
      assessmentDate: initialData.assessment_data?.assessmentDate ?? initialData.assessmentDate,
      discussionWith: initialData.assessment_data?.discussionWith ?? initialData.discussionWith,
      viewsExpressed: initialData.assessment_data?.viewsExpressed ?? initialData.viewsExpressed,
      optionsConsidered: initialData.assessment_data?.optionsConsidered ?? initialData.optionsConsidered,
      reasonForPreferredOption: initialData.assessment_data?.reasonForPreferredOption ?? initialData.reasonForPreferredOption,
      risksIfNotFollowed: initialData.assessment_data?.risksIfNotFollowed ?? initialData.risksIfNotFollowed,
      decisionOutcome: initialData.assessment_data?.decisionOutcome ?? initialData.decisionOutcome,
      summaryRationale: initialData.assessment_data?.summaryRationale ?? initialData.summaryRationale,
      decisionMakerName: initialData.assessment_data?.decisionMakerName ?? initialData.decisionMakerName,
      decisionMakerRole: initialData.assessment_data?.decisionMakerRole ?? initialData.decisionMakerRole,
      decisionMakerSignature: initialData.assessment_data?.decisionMakerSignature ?? initialData.decisionMakerSignature,
      decisionMakerDate: initialData.assessment_data?.decisionMakerDate ?? initialData.decisionMakerDate,
      witnessName: initialData.assessment_data?.witnessName ?? initialData.witnessName,
      witnessRole: initialData.assessment_data?.witnessRole ?? initialData.witnessRole,
      witnessSignature: initialData.assessment_data?.witnessSignature ?? initialData.witnessSignature,
      witnessDate: initialData.assessment_data?.witnessDate ?? initialData.witnessDate,
      nextOfKinName: initialData.assessment_data?.nextOfKinName ?? initialData.nextOfKinName,
      nextOfKinRelationship: initialData.assessment_data?.nextOfKinRelationship ?? initialData.nextOfKinRelationship,
      nextOfKinSignature: initialData.assessment_data?.nextOfKinSignature ?? initialData.nextOfKinSignature,
      nextOfKinDate: initialData.assessment_data?.nextOfKinDate ?? initialData.nextOfKinDate,
      savedAsDraft: initialData.assessment_data?.savedAsDraft ?? initialData.savedAsDraft,
      createdAt: initialData.assessment_data?.createdAt ?? initialData.createdAt,
    } : {
      residentId,
      teamId,
      organizationId,
