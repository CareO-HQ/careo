...
// Get all active clinical audit templates for an organization
...
// Create a new clinical audit template
export const createTemplate = mutation({
  ...
  handler: async (ctx, args) => {
    const templateId = await ctx.db.insert("clinicalAuditTemplates", {
      name: args.name,
